...
lgpoURL = 'https://github.com/ardavanhashemzadeh/lgpo/raw/master/LGPO.exe' # Microsoft LGPO link
win10gpoURL = 'https://github.com/ardavanhashemzadeh/lgpo/raw/master/GPO.zip' # Encrypted Zipped GPO backup in folder named 'GPO' - GPO.zip => /GPO/{GPO Backup Files}
win10admxURL = 'https://github.com/ardavanhashemzadeh/lgpo/raw/master/ADMX.zip' # Encrypted Zipped ADMX + ADML in folder named 'ADMX' - => /ADMX/{ADMX Files}/en-us/{ADML Files}

zipPWD = "helloworld" # Encrypted zip password. Note! use the same password for all zip files. 
